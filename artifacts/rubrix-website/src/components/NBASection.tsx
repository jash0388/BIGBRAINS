...
export default function NBASection() {
  return (
    <section id="nba" className="py-24 bg-[#F9FBFF]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl font-extrabold text-[#182B68] mb-4"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative w-72 h-72">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#EEF2FF] to-[#F5F0FF] border-2 border-dashed border-[#3D65F4]/20 flex items-center justify-center">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#3D65F4] to-[#7C5CFC] flex items-center justify-center shadow-xl">
              ...
              {nodes.map((node, i) => {
                ...
                return (
                  <motion.div
                    ...
                    style={{ left: `${x}%`, top: `${y}%` }}
                  >
                    <div className="bg-white border border-[#3D65F4]/30 rounded-full px-3 py-1 text-xs font-semibold text-[#182B68] shadow-md whitespace-nowrap">
                      {node.label}
                    </div>
                  </motion.div>
                );
          ...
          <div className="space-y-5">
            {features.map((f, i) => (
              <motion.div
                ...
                className="flex gap-4 items-start bg-white rounded-2xl p-5 border border-orange-50 hover:border-[#FF6B4A]/30 hover:shadow-md transition-all"
              >
