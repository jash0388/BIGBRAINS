...
export default function NBASection() {
  ...
  return (
    <section ref={ref} id="nba" style={{ background: "#020202", padding: "7rem 1.5rem 9rem", position: "relative", overflow: "hidden" }}>
      <div style={{
        position: "absolute", bottom: "0%", right: "-5%",
        width: "45vw", height: "45vh",
        background: "radial-gradient(ellipse, rgba(255,107,74,0.07) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
        ...
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          ...
          <motion.h2 custom={1} variants={fadeUp} initial="hidden" animate={inView ? "visible" : "hidden"}
            style={{
              ...
              color: "rgba(255,255,255,0.95)", marginBottom: "1rem",
            }}>
          ...
          <motion.div custom={3} variants={fadeUp} initial="hidden" animate={inView ? "visible" : "hidden"}
            ...
            <div style={{ position: "relative", width: "260px", height: "260px" }}>
              <div style={{
                ...
                border: "1.5px dashed rgba(255,107,74,0.2)",
                display: "flex", alignItems: "center", justifyContent: "center",
              }}>
                <div style={{
                  width: "5rem", height: "5rem", borderRadius: "50%",
                  background: "linear-gradient(135deg, rgba(255,107,74,0.8), rgba(220,60,30,0.8))",
                  display: "flex", alignItems: "center", justifyContent: "center",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {features.map((f, i) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <p style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 500, fontSize: "0.875rem", color: "rgba(255,255,255,0.8)", marginBottom: "0.25rem" }}>{f.title}</p>
                  <p style={{ fontFamily: "'Barlow', sans-serif", fontWeight: 300, fontSize: "0.8rem", color: "rgba(255,255,255,0.35)", lineHeight: 1.6 }}>{f.desc}</p>
                </div>
                <CheckCircle size={14} color="rgba(16,185,129,0.5)" style={{ flexShrink: 0, marginTop: "0.25rem" }} />
              </motion.div>
            ))}
          </div>
        </div>
